...
| -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| [ci-branch_plan](https://github.com/percebus/github-actions-terraform/deployments//deployments/ci-branch_plan) | [ci-branch](https://github.com/percebus/github-actions-terraform/deployments//deployments/ci-branch) | [C]ontinuous [I]ntegration for branches other than main |
| [ci-main_plan](https://github.com/percebus/github-actions-terraform/deployments//deployments/ci-main_plan)     | [ci-main](https://github.com/percebus/github-actions-terraform/deployments//deployments/ci-main)     | [C]ontinuous [I]ntegration for the `main` branch        |
| [dev_plan](https://github.com/percebus/github-actions-terraform/deployments//deployments/dev_plan)             | [dev](https://github.com/percebus/github-actions-terraform/deployments//deployments/dev)             | [Dev]elopment environment                               |
| [prod_plan](https://github.com/percebus/github-actions-terraform/deployments//deployments/prod_plan)           | [prod](https://github.com/percebus/github-actions-terraform/deployments//deployments/prod)           | [Prod]uction environment                                |
